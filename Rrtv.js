...
hostname = api.rr.tv
[Script]
http-response ^https:\/\/api\.rr\.tv(\/user\/privilege\/list|\/ad\/getAll|\/rrtv-video\/v4plus\/season\/detail) requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/jiihsu/Surge-script/master/Rrtv.js,script-update-interval=0
*/
